	...
	: Panner1in2out (p)
{
	...
	left_dist_buf.reset(new PanDelayBuffer(session));
	right_dist_buf.reset(new PanDelayBuffer(session));
}

Panner1in2outDelay::~Panner1in2outDelay ()
{
}
